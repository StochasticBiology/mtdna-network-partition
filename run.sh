...
./network-sim.ce --snapshots 0 0.5 4 0 0 0 0 > tmps1 &
./network-sim.ce --snapshots 0 0.5 4 0.5 0.5 0 0 > tmps2 &
./network-sim.ce --snapshots 0 0.5 4 1 0 0 0 > tmps3 &
./network-sim.ce --snapshots 0 0.5 16 0.5 0.5 0 0 > tmps4 &
./network-sim.ce --snapshots 0 0.5 64 0.5 0.5 0 0 > tmps5 &
./network-sim.ce --snapshots 0 0.5 16 1 1 0 0 > tmps6 &
./network-sim.ce --snapshots 0 0.5 16 1 1 0.04 0 > tmps7 &
./network-sim.ce --snapshots 0 0.5 16 1 1 0.1 0 > tmps8 &
./network-sim.ce --snapshots 0 0.5 16 1 1 0. 0.1 > tmps9 &
