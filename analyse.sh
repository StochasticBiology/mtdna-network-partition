...
head -n1 output-0.000-0.100-4.csv > output-symm.csv
# concatenate results, prune individual headers, and append to big file
cat output-0.000-0.100-4.csv output-0.000-0.100-16.csv output-0.000-0.100-64.csv output-0.000-0.500-4.csv output-0.000-0.500-16.csv output-0.000-0.500-64.csv | grep -v "h" >> output-symm.csv
...
Rscript compare-both-asymm.R output-symm.csv 1 100 50 0.5 symm
# effect of lambda
